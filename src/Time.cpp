...
void Play_Speech() {
  String CPray = "";  //", โชคดีที่รอดมาอีก 1 วัน, ขอสรรพสัตว์ทั้งหลายจงมีความสุข, อันตัวเรานั้น ตายแน่ ตายแน่";
  Sawasdee(4,0,10,59,("สวัสดีตอนเช้า, วันนี้ฉันมีความสุขมาก"+CPray));    
  Sawasdee(11,0,11,59,("สวัสดีตอนเพล, วันนี้ฉันมีความสุขมาก"+CPray));    
  Sawasdee(12,0,12,59,("สวัสดีตอนเที่ยง, วันนี้ฉันมีความสุขมาก"+CPray));    
  Sawasdee(13,0,15,59,("สวัสดีตอนบ่าย, วันนี้ฉันมีความสุขมาก"+CPray));    
  Sawasdee(16,0,17,59,("สวัสดีตอนเย็น, วันนี้ฉันมีความสุขมาก"+CPray));    
  Sawasdee(18,0,18,30,("สวัสดีตอนพลบค่ำ, วันนี้ฉันมีความสุขมาก"+CPray));    
  Sawasdee(18,31,23,59,("สวัสดีตอนค่ำ, วันนี้ฉันมีความสุขมาก"+CPray));    
  Sawasdee(0,0,0,10,("สวัสดีตอนเที่ยงคืน, ทำไมวันนี้อยู่ดึกจัง"+CPray));    
  Sawasdee(0,11,3,59,("สวัสดีตอนดึก, ขณะนี้เวลานอน ควรหลับในอู่ทะเลบุญ"+CPray));  
